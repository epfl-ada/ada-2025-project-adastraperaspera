...
// ToDo: improve the plot based on src.scripts.visualization.plots.plot_pig_comp_heatmap; usage in results.ipynb
// Zoom in, transparent background
<p align="center">
...
// ToDo: when incorporating into the website, please use the html generated by src.scripts.visualization.interactive_plots.interactive_comp_pig_regression_grid; usage in results.ipynb
// Note: please keep the 4x4 grid layout; don't collapse to a single plot with a dropdown.
<p align="center">
  <img src="figures/interactive_PIG_by_broad_type.png" width="160">
  <br><em>PIG expression by broad type</em>
</p>
