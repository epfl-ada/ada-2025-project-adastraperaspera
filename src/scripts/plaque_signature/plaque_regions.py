...
# -------------------------------------------------------
# 1. Create plaque-region mask (binary label)
# -------------------------------------------------------
...
# -------------------------------------------------------
# 3. Summarize plaques by number of local cells
# -------------------------------------------------------
...
# -------------------------------------------------------
# 4. Select meaningful plaques (>= N cells in local region)
# -------------------------------------------------------
def select_big_plaques(plaque_summary, min_cells=100):
    big_plaques = plaque_summary[
        plaque_summary["local_cells"] >= min_cells
    ]["plaque_id"].tolist()
    return big_plaques


# -------------------------------------------------------
# 5. Extract bounding boxes for each selected plaque
# -------------------------------------------------------
...
# -------------------------------------------------------
# 6. Extract matched WT regions for each plaque's bounding box
# -------------------------------------------------------
