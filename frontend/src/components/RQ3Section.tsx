          ...
          <div className="space-y-12">
            ...
            <div id="rq3-mean" className="space-y-4">
              ...
              <ul className="space-y-3 text-muted-foreground">
                  <p className="text-lg text-muted-foreground leading-relaxed">
                We group cells into <span className="font-medium text-foreground">5 equal-count distance bins</span> and compute, for each PIG:
                </p>
                  <li className="flex items-start gap-2">
                    <CircleChevronRight className="w-4 h-4 text-primary mt-1 flex-shrink-0" />
                    mean <span className="font-medium text-foreground">log1p-normalized</span> transcript count per bin  
                  </li>
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                An ANOVA confirms that <span className="font-medium text-foreground">all 16 PIGs</span> have significant differences in mean expression across distance bins at <span className="font-medium text-foreground">Bonferroni-corrected FDR = 0.01</span>.
              </p>
              ...
              <ul className="space-y-3 text-muted-foreground">
                <p className="text-lg text-muted-foreground leading-relaxed">
                  ...
                  <span>
                    ...
                    <span className="font-medium text-foreground">Gfap</span>, which shows the
                    largest proximal-to-distal mean difference on the log1p scale:
                  </span>
                </p>
                ...
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    Δ(log1p mean) ≈{" "}
                    <span className="font-medium text-foreground">0.72</span> between closest
                    and farthest bins
                  </span>
                </li>
            ...
            <div id="rq3-regression" className="space-y-4">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                To increase explanatory power (R²), reduce heteroscedasticity, and test whether plaque shape contributes to local responses, we compute geometric properties of the nearest plaque for each cell: <span className="font-medium text-foreground">area, perimeter, major axis length and orientation</span>.
              </p>
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                ...
                two additional <span className="font-medium text-foreground">
                multi-plaque proximity features</span> computed within a radius{" "}
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                To validate that R is informative, we check the Count distribution and CDF. The distribution shows meaningful variation: <span className="font-medium text-foreground">55.2%</span> of cells have <span className="font-medium text-foreground">0</span> plaques within 61 µm, while the remainder have up to <span className="font-medium text-foreground">21</span> plaques within that radius—indicating a usable local density signal.
              </p>
              <PlotFrame
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
               To capture local cell–cell context and spatial signaling, we compute neighborhood mean expression features: for each cell and each PIG, we summarize the expression of the <span className="font-medium text-foreground">15 other PIGs</span> across its <span className="font-medium text-foreground">k = 100 nearest neighbors</span>.
               </p>
              ...
              <ul className="mt-3 space-y-3 text-sm text-muted-foreground">
                ...
                We systematically quantify how each feature group improves PIG prediction using nested linear models for each PIG:
                  ...
                  <li className="flex items-start gap-2">
                    <CircleChevronRight className="w-4 h-4 text-primary mt-1 flex-shrink-0" />
                    <span>
                      <span className="font-medium text-foreground">Model 0:</span>{" "}
                      distance only
                    </span>
                  </li>
                  ...
                  <li className="flex items-start gap-2">
                    <CircleChevronRight className="w-4 h-4 text-primary mt-1 flex-shrink-0" />
                    <span>
                      <span className="font-medium text-foreground">Model 1:</span>{" "}
                      distance + plaque geometry
                    </span>
                  </li>
                  ...
                  <li className="flex items-start gap-2">
                    <CircleChevronRight className="w-4 h-4 text-primary mt-1 flex-shrink-0" />
                    <span>
                      <span className="font-medium text-foreground">Model 2:</span>{" "}
                      distance + plaque geometry + multi-plaque proximity
                    </span>
                  </li>
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      Model 2 + neighborhood PIG context features using the top 1 / 2 / 4 / 8 / 15
                      neighbor PIGs (ranked by correlation)
                    </span>
                  </li>
                </ul>
                ...
                We systematically quantify how each feature group improves PIG prediction using nested linear models for each PIG:
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      (mean improvement{" "}
                      <span className="font-medium text-foreground">+0.074</span>). This is consistent
                      with plaque proximity acting as a common confounder that drives coordinated PIG
                      activation.
                    </span>
                  </li>
                  ...
                  <li className="flex items-start gap-2">
                    <CircleChevronRight className="w-4 h-4 text-primary mt-1 flex-shrink-0" />
                    <span>
                      Additional neighbor PIG proxies provide diminishing but still significant gains
                      (e.g.,{" "}
                      <span className="font-medium text-foreground">+0.036</span>{" "}
                      for the next increment), and the nested analysis favors using up to{" "}
                      <span className="font-medium text-foreground">15</span>{" "}
                      neighbor PIGs even though most benefit comes from the first proxy.
                    </span>
                  </li>
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <span className="font-medium text-foreground">Gfap</span>{" "}
                      achieves the highest adjusted R² in{" "}
                      <span className="font-medium text-foreground">7 of 8</span>{" "}
                      model variants, consistent with it being strongly distance-linked.
                    </span>
                  </li>
                  ...
                  <li className="flex items-start gap-2">
                    <CircleChevronRight className="w-4 h-4 text-primary mt-1 flex-shrink-0" />
                    <span>
                      <span className="font-medium text-foreground">Cxcl10</span>{" "}
                      is lowest in{" "}
                      <span className="font-medium text-foreground">5 of 8</span>{" "}
                      model variants, consistent with extreme zero inflation limiting explainable
                      variance.
                    </span>
                  </li>
                  ...
                  <li className="flex items-start gap-2">
                    <CircleChevronRight className="w-4 h-4 text-primary mt-1 flex-shrink-0" />
                    <span>
                      Plaque geometry (Model 1) and multi-plaque proximity (Model 2) yield statistically
                      significant (but modest) improvements in adjusted R² for{" "}
                      <span className="font-medium text-foreground">15 of 16 PIGs</span>{" "}
                      (average improvements ~{" "}
                      <span className="font-medium text-foreground">0.0021</span>{" "}
                      and{" "}
