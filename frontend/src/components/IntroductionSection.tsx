        ...
        <div className="grid gap-10 lg:grid-cols-[1fr_360px] items-start">
          ...
          <div className="space-y-6">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed">
              ...
              With the knowledge of <em>which</em> cells and <em>which</em> genes respond <em>where</em> around the plaques, drug developers can pre-filter therapeutic targets accessible from the vasculature.
            </p>
